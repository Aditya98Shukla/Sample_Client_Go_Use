...
import (
	...
	v1 "Persona_CRD/pkg/client/listers/foo/v1"
	"context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.FooV1().HelloTypes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FooV1().HelloTypes(namespace).Watch(context.TODO(), options)
			},
		},
		&foov1.HelloType{},
		resyncPeriod,
